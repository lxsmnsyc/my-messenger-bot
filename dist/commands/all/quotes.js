...
function requestProgrammingQuotes(client, thread) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, axios_1.default.get('https://programming-quotes-api.herokuapp.com/quotes/random')];
                case 1:
                    data = (_a.sent()).data;
...
exports.default = (function (client) {
    return client.addCommand('/quotes')
